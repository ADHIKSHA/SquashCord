 ...
 */
declare class Hu extends ua {
    static ca(t: any, e: any, n: any): Hu;
    static ia(t: any, e: any, n: any): Hu;
...
/** Immutable class holding a blob (binary data) */ declare class Lu extends ua {
 ...
 * limitations under the License.
 */
/** DOMException error code constants. */ declare const Ta: -1;
declare function Wu(t: any): void;
declare class Zu extends ua {
    constructor(t: any, e: any);
    _firestore: any;
    get ref(): Hu;
    get id(): any;
...
declare class Ku extends vu {
    constructor(t: any);
    firestore: any;
    convertBytes(t: any): Lu;
    convertReference(t: any): Hu;
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 */ declare class ga {
    ...
    enqueueAfterDelay(t: any, e: any, n: any): _o;
    vc(): void;
...
/** A CredentialsProvider that always yields an empty token. */ declare class Hc {
    /**
...
declare class $r {
    ...
    Zi(): void;
    cancel(): void;
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ Xi(): number;
}
/**
 * @license
 * Copyright 2017 Google LLC
...
declare class _o {
     ...
     */ static createAndSchedule(t: any, e: any, n: any, s: any, i: any): _o;
 ...
 * limitations under the License.
 */ declare class K {
    static fromPath(t: any): K;
    static fromName(t: any): K;
...
declare namespace _r {
    const UNAUTHENTICATED: _r;
    const GOOGLE_CREDENTIALS: _r;
    const FIRST_PARTY: _r;
}
export { Gu as G, Hu as H, Ia as I, Lu as L, Qu as Q, Ta as T, Wu as W, Zu as Z, ah as a, ch as c, eh as e, ih as i, ju as j, oh as o, qu as q, sh as s, th as t, uh as u, xa as x };
