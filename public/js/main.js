...
document.getElementById( 'toggle-mute' ).addEventListener( 'click', async function ( e ) {
  e.preventDefault();
...
function setUpPeer(peerUuid, displayName, initCall = false) {
  if(peerUuid in connected)
    return;
  peerConnections[peerUuid] = { 'uuid': peerUuid, 'pc': new RTCPeerConnection(servers) ,'displayName' : displayName };
